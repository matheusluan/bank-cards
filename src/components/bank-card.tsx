            ...
            >
                ...
                <div className="absolute top-5 left-5">
                    {brand === CardBrand.VISA && (
                        <Image width={40} height={40} className="w-auto h-auto" src="/icons/visa-logo.svg" alt="Visa" />
                    )}
                    {brand === CardBrand.MASTERCARD && (
                        <Image width={40} height={40} className="w-auto h-auto" src="/icons/mastercard-logo.svg" alt="Mastercard" />
                    )}
                </div>
